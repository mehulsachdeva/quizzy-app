...
function generateQuestions(){
	...
	if(i<3){
		...
		html1+="<input type='radio' name=question_id[0] value='q1-A' id=question_id[0]>"+" "+"<span style='font-family:Trebuchet MS;color:#566573;'>"+sample[random_digit][2]+"</span>"+"<br>";
		html1+="<input type='radio' name=question_id[0] value='q1-B' id=question_id[0]>"+" "+"<span style='font-family:Trebuchet MS;color:#566573;'>"+sample[random_digit][3]+"</span>"+"<br>";
		html1+="<input type='radio' name=question_id[0] value='q1-C' id=question_id[0]>"+" "+"<span style='font-family:Trebuchet MS;color:#566573;'>"+sample[random_digit][4]+"</span>"+"<br>";
		html1+="<input type='radio' name=question_id[0] value='q1-D' id=question_id[0]>"+" "+"<span style='font-family:Trebuchet MS;color:#566573;'>"+sample[random_digit][5]+"</span>"+"<br>";
...
function checkAnswer(){
	...
	var html1='';
	var random_digit=random[i]-1;
	if(document.getElementById('q1').value==sample[random_digit][0]){
		mark+=1;
	}
	if(document.getElementById('q2').value==sample[random_digit][0]){
		mark+=1;
	}
	if(document.getElementById('q3').value==sample[random_digit][0]){
		mark+=1;
	}
}
